...
class accepted_post_adaptar(private val homefeed: List<Video1>):


    RecyclerView.Adapter<accepted_post_adaptar.ExampleViewHolder>() {
    ...
    inner class ExampleViewHolder(itemView: View):RecyclerView.ViewHolder(itemView){
        ...
        init {
            itemView.setOnClickListener {
                ...
                val intent = Intent (itemView.context, accepted_task_detail::class.java)
