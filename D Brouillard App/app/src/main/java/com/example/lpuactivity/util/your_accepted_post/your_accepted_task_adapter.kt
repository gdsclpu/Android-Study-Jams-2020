...
import com.example.lpuactivity.util.Personal_Post.Personal_post_detail

import com.squareup.picasso.Picasso
import kotlinx.android.synthetic.main.activity_your_accepted_work.view.*
import kotlinx.android.synthetic.main.fragment_recycle_home.view.*
import kotlinx.android.synthetic.main.your_accepted_task_view.view.*

class your_accepted_task_adapter(private val homefeed: List<Video1>):


    RecyclerView.Adapter<your_accepted_task_adapter.ExampleViewHolder>() {
...
//        }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ExampleViewHolder {
        ...
        val cellofrow=layoutInflater.inflate(R.layout.your_accepted_task_view,parent,false)
    ...
    override fun onBindViewHolder(holder: ExampleViewHolder, position: Int) {
        ...
        val video=homefeed[position]
        holder.itemView.your_accepted_task_title.text=video.title
        holder.itemView.your_accepted_task_number.text="Accepted By : "+ video.doneby

        val imageholder=holder.itemView.your_accepted_task_image
